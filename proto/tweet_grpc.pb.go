...
const (
	TweetService_GetTweetComment_FullMethodName = "/tweet.TweetService/GetTweetComment"
)
...
type TweetServiceClient interface {
	GetTweetComment(ctx context.Context, in *TweetRequest, opts ...grpc.CallOption) (*TweetResponse, error)
}
...
func (c *tweetServiceClient) GetTweetComment(ctx context.Context, in *TweetRequest, opts ...grpc.CallOption) (*TweetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TweetResponse)
	err := c.cc.Invoke(ctx, TweetService_GetTweetComment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TweetServiceServer interface {
	GetTweetComment(context.Context, *TweetRequest) (*TweetResponse, error)
...
func (UnimplementedTweetServiceServer) GetTweetComment(context.Context, *TweetRequest) (*TweetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTweetComment not implemented")
}
...
func _TweetService_GetTweetComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TweetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TweetServiceServer).GetTweetComment(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TweetService_GetTweetComment_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TweetServiceServer).GetTweetComment(ctx, req.(*TweetRequest))
	}
...
var TweetService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetTweetComment",
			Handler:    _TweetService_GetTweetComment_Handler,
		},
	},
